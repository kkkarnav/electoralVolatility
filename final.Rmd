...
model_rc <- plm(volatility ~ relative_change_p3_t + election_year + factor(state), data = filterpanel, index=c("state", "ac_name", "election_year"), model="within")

model_rc2 <- plm(incumb_change ~ relative_change_p3_t + election_year + factor(state), data = filterpanel, index=c("state", "ac_name", "election_year"), model="within")

model_rc3 <- plm(state_incumb_change ~ relative_change_p3_t + election_year + factor(state), data = filterpanel, index=c("state", "ac_name", "election_year"), model="within")

model_rc4 <- plm(nat_incumb_change ~ relative_change_p3_t + election_year + factor(state), data = filterpanel, index=c("state", "ac_name", "election_year"), model="within")
...
model_rc <- plm(volatility ~ relative_change_p3_t + election_year + factor(state), data = filterpanel2, index=c("state", "ac_name", "election_year"), model="within")

model_rc2 <- plm(incumb_change ~ relative_change_p3_t + election_year + factor(state), data = filterpanel2, index=c("state", "ac_name", "election_year"), model="within")

model_rc3 <- plm(state_incumb_change ~ relative_change_p3_t + election_year + factor(state), data = filterpanel2, index=c("state", "ac_name", "election_year"), model="within")

model_rc4 <- plm(nat_incumb_change ~ relative_change_p3_t + election_year + factor(state), data = filterpanel2, index=c("state", "ac_name", "election_year"), model="within")
