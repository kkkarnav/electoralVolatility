...
panel <- panel%>%
  ...
  mutate(
    cycle = case_when(
      delta_year >= 2021 & delta_year <= 2025 ~ 2021,
      delta_year >= 2016 & delta_year <= 2020 ~ 2016,
      delta_year >= 2011 & delta_year <= 2015 ~ 2011,
      delta_year >= 2006 & delta_year <= 2010 ~ 2006,
      delta_year >= 2001 & delta_year <= 2005 ~ 2001,
      delta_year >= 1996 & delta_year <= 2000 ~ 1996,
      delta_year >= 1991 & delta_year <= 1995 ~ 1991,
    ))
```
...
model_rc <- plm(volatility ~ relative_change_t + election_year + delta_ENOP + delta_Turnout + years_since_election + Electors + factor(state), data = panel, index=c("state", "ac_name", "election_year"), model="within")

model_rc2 <- plm(incumb_change ~ relative_change_t + election_year + delta_ENOP + delta_Turnout + years_since_election + Electors + factor(state), data = panel, index=c("state", "ac_name", "election_year"), model="within")

model_rc3 <- plm(state_incumb_change ~ relative_change_t + election_year + delta_ENOP + delta_Turnout + years_since_election + Electors + factor(state), data = panel, index=c("state", "ac_name", "election_year"), model="within")

model_rc4 <- plm(nat_incumb_change ~ relative_change_t + election_year + delta_ENOP + delta_Turnout + years_since_election + Electors + factor(state), data = panel, index=c("state", "ac_name", "election_year"), model="within")
...
model_rc <- plm(volatility ~ relative_change + election_year + factor(state), data = filterpanel, index=c("state", "ac_name", "election_year"), model="within")

model_rc2 <- plm(incumb_change ~ relative_change + election_year + factor(state), data = filterpanel, index=c("state", "ac_name", "election_year"), model="within")

model_rc3 <- plm(state_incumb_change ~ relative_change + election_year + factor(state), data = filterpanel, index=c("state", "ac_name", "election_year"), model="within")

model_rc4 <- plm(nat_incumb_change ~ relative_change + election_year + factor(state), data = filterpanel, index=c("state", "ac_name", "election_year"), model="within")
...
model_rc <- plm(volatility ~ relative_change + election_year + factor(state), data = filterpanel2, index=c("state", "ac_name", "election_year"), model="within")

model_rc2 <- plm(incumb_change ~ relative_change + election_year + factor(state), data = filterpanel2, index=c("state", "ac_name", "election_year"), model="within")

model_rc3 <- plm(state_incumb_change ~ relative_change + election_year + factor(state), data = filterpanel2, index=c("state", "ac_name", "election_year"), model="within")

model_rc4 <- plm(nat_incumb_change ~ relative_change + election_year + factor(state), data = filterpanel2, index=c("state", "ac_name", "election_year"), model="within")
