...
``` {r panel_table, echo=FALSE, eval=FALSE}
panel_table <- panel%>%
...
stargazer(model_ac, model_ac2, model_ac3, model_ac4, report=("vcsp*"))
```
...
stargazer(model_rc, model_rc2, model_rc3, model_rc4, report=("vcsp*"))
```
